      ...
      <div id="footer-section" className="footer-section">
        <div className="footer-container">
          ...
          <div id="important">
            ...
            <ul>
              <li onClick={() => scrollToSection("features")}>Face Recognition</li>
              <li onClick={() => scrollToSection("how")}>Roaming Detection</li>
              <li onClick={() => scrollToSection("features")}>Gate Pass System</li>
              <li onClick={() => scrollToSection("features")}>Smart Chat Module</li>
            </ul>
          </div>
          ...
          <div id="contact">
            <h3>CONTACT INFO</h3>
            <ul>
              <li>📍 Shreeyash Polytechnic, Chhatrapati Sambhajinagar</li>
              <li>📧 campusview@gmail.com</li>
              <li>📸 Instagram : rajput_mansii30</li>
              <li> 📸 Instagram : dahale.aditya</li>
              <li>📱 +91- 7020302969</li>
            </ul>
          </div>
